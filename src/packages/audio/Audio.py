...
class Audio:
    ...
    @keyword
    def extract_words_from_audio(self, filePath: str, outputDir: str):
        json_path = os.path.join(outputDir, "words.json")
        api = RequestApi(appid="a86c3fb9",
                         secret_key="50b83dd36c1f1b4372cfb5c97106409b",
                         upload_file_path=filePath)
        result: dict = api.all_api_request()
